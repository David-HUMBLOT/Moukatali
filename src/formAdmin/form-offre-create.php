                ...
                <tr>
                  ...
                  <?php if ($_SESSION['user']['role'] == "admin") : ?>
                    <td class="align-middle">
                      <?php if ($offre['published'] == 1) : ?>
                        <a href="offre.php?unpublish=<?= $offre['id'] ?>" role="button">
                      ...
                      <?php else : ?>
                        <a href="offres.php?publish=<?= $offre['id'] ?>" role="button">
                  ...
                  <?php endif; ?>
                  <td class="align-middle">
                    <a class="text-dark" href="form-subject.php?edit-offre=<?= $offre['id'] ?>" role="button">
                  ...
                  <td class="align-middle">
                    <a class="text-dark" href="offres.php?delete-offre=<?= $offre['id'] ?>" role="button">
