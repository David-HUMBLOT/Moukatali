...
<body>
    ...
    <!-- <div class=" row  d-flex justify-content-center mx-1 ">
        <div class="card  text-white bg-dark m-3 mb-4  col-lg-5 col-md-5 " style="max-width: 12rem; border-color:aqua">
            ...
            <div class="card-body text-center">
                <img src="../../images/kisspng-court-piece-gift-game-smartphone-gift-box-open-fly-out-of-the-phone-vector-5a697a82ca38e5.4876160315168620828283.png" class="img-fluid " alt="..." style="width: 70%;">
  ...
  <div class="col mb-4">
    <div class="card h-100">
      <img src="../../images/logo_moukatali_noir.png" class="card-img-top"style="height: 30vh;" alt="...">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
  ...
  <div class="col mb-4">
    <div class="card h-100">
      <img src="../../images/974-west-coast-1.jpg" class="card-img-top" style="height: 30vh;" alt="...">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
