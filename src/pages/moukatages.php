...
<body>
   ...
   <div class="sujet bg-light p-3 mb-3 d-flex flex-column flex-md-row align-items-md-center">
                <div class="image mb-2 mb-md-0 mr-md-2 d"><img src=<?= BASE_URL . "/public/images/uploads/" . $topics[0]['image'] ?> alt="Image du sujet"></div>
           
               
                <p class="text-dark"><?php echo($topics[0]['title']); ?></p>
            </div>
