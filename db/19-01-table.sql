...
CREATE TABLE `user_info` (
  ...
  `password` varchar(255) NOT NULL,
  `my_points` mediumint(9) DEFAULT NULL,
  `vote_for` mediumint(9) DEFAULT NULL,
  `vote_against` mediumint(9) DEFAULT NULL,
...
INSERT INTO `user_info` (`id`, `user_id`, `username`, `first_name`, `last_name`, `email`, `phone`, `password`, `my_points`, `vote_for`, `vote_against`, `my_vote_for`, `my_vote_against`, `role`, `registration_date`, `update_date`) VALUES
(1, 1, 'admin', 'Admin', 'Admin', 'admin@admin.com', '0692000000', '$2y$10$LlUcS4V0Z4Ai3n2iik.oZeqvBVQ230GImZ0PJMR4F6NRHr3zHnRqK', NULL, NULL, NULL, NULL, NULL, 'admin', '2021-01-18 07:04:08', '2021-01-18 07:04:08'),
(3, 7, 'John', 'John', 'Doe', 'john@doe.com', '0692000000', '$2y$10$tjiNip9oRGECxvRwU65eBeuTLK3vTgGKyWsv56Kn1Ls2/.z2rgsZG', NULL, NULL, NULL, NULL, NULL, NULL, '2021-01-18 07:51:50', '2021-01-18 07:51:50'),
(4, 8, 'moderator', 'Moderator', 'Moderator', 'moderator@moderator.com', NULL, '$2y$10$JwUheot7MdU5Cguj4.rja.CVpo8d46MFb95hCxiEfuUEksKpO3H8q', 0, 0, 0, 0, 0, 'moderator', '2021-01-18 12:47:26', '2021-01-18 12:47:26'),
(5, 9, 'author', 'Author', 'Author', 'author@author.com', NULL, '$2y$10$O2zdog2.e6BATFKu0P62sus4DgaTHWOmDr09C4IcEDWJKSiByIbi2', 0, 0, 0, 0, 0, 'author', '2021-01-18 12:48:33', '2021-01-18 12:48:33');
