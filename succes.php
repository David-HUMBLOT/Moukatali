        ...
        <div class="row d-flex justify-content-center mx-3">
            ...
            <div class="row d-flex justify-content-center mb-5   col-lg-6 col-md-6" id="box-formulaire">
                ...
                <div id="avatar">
                    ...
                    <!---SUCCESS...)-->
                    <div id="box-succes" class=" row d-flex justify-content-center mb-5">
                    ...
                    <div class="container-fluid d-flex justify-content-around mb-3  " style="height: 40px;">
                        <a href="profile.html"><button id="btn_succes"
                                class="btn btn-dark text-light  rounded-pill btn-sm fw-bolder" type="submit">Mon
                                profil</button></a>
